...
var _pickBy2 = __webpack_require__(79);

var _pickBy3 = _interopRequireDefault(_pickBy2);

var _forEach2 = __webpack_require__(144);

var _forEach3 = _interopRequireDefault(_forEach2);

var _isString2 = __webpack_require__(150);
...
var _isNil2 = __webpack_require__(151);

var _isNil3 = _interopRequireDefault(_isNil2);

var _mapValues2 = __webpack_require__(152);

var _mapValues3 = _interopRequireDefault(_mapValues2);

var _map2 = __webpack_require__(153);
...
var valuesToLengths = function valuesToLengths(arr) {
  return (0, _map3.default)(arr, function (a) {
    return (0, _mapValues3.default)(a, function (val, key) {
      if ((0, _isNil3.default)(val) || (0, _isFunction3.default)(val) || (0, _isObject3.default)(val) || (0, _isArray3.default)(val)) return 0;else if ((0, _isString3.default)(val)) return val.length;else return val.toString().length;
    });
  });
};
...
var getColumnWidths = function getColumnWidths(arr, options) {
  ...
  (0, _forEach3.default)(arr, function (a) {
    (0, _forEach3.default)(a, function (len, key) {
      if (retval[key]) retval[key] = Math.max(len, retval[key]);else retval[key] = len;
    });
  });

  if (options.showHeader === true) {
    (0, _forEach3.default)(retval, function (len, key) {
...
var sanitizeItems = function sanitizeItems(arr) {
  var arr = [].concat(arr);

  return (0, _map3.default)(arr, function (a) {
    return (0, _pickBy3.default)(a, function (val) {
      return (0, _isString3.default)(val) || (0, _isNumber3.default)(val);
    });
  });
};
...
var renderList = function renderList(arr, options, lengths) {
  ...
  if (options.showHeader === true) {
    (0, _forEach3.default)(lengths, function (val, key) {
  ...
  (0, _forEach3.default)(arr, function (a) {
    (0, _forEach3.default)(a, function (val, key) {
      var len = lengths[key] + options.spacing;

      if ((0, _isString3.default)(val)) retval += (val + ' '.repeat(len)).substr(0, len);else retval += (val.toString() + ' '.repeat(len)).substr(0, len);
    });
...
exports.default = function (items, options) {
  var options = (0, _assign3.default)({}, default_options, options);

  if (options.showHeader !== false) options.showHeader = true;

  if (!(0, _isNumber3.default)(options.spacing)) options.spacing = 1;

  if (!(0, _isArray3.default)(items) || items.length == 0) return '';
